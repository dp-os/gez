...
## 常规配置
### name <Badge text="v1.0.0" type="tip" />
- **类型：**`string`
- **默认值：**`gez`
- **描述：** 服务的名称，全局唯一。
...
### root <Badge text="v1.0.0" type="tip" />
- **类型：**`string`
- **默认值：**`cwd()`
...
### isProd <Badge text="v1.0.0" type="tip" />
- **类型：**`boolean`
...
### isInstall <Badge text="v1.0.0" type="tip" />
- **类型：**`boolean`
...
### dynamicBasePathVar <Badge text="v1.0.0" type="tip" />
- **类型：**`string | false`
...
## 模块链接
这是 Gez 的核心功能，深入了解[点击这里](./module-link.mdx)。
### modules.exports <Badge text="v1.0.0" type="tip" />
- **类型：**`string[]`
- **默认值：** `[]`
- **描述：** 对外模块导出。
...
### modules.imports <Badge text="v1.0.0" type="tip" />
...
### modules.externals <Badge text="v1.0.0" type="tip" />
...
:::tip
需要配合 [modules.imports](#modulesimports) 使用。
:::

## 回调函数

### postCompileProdHook() <Badge text="v1.0.0" type="tip" />
...
### createDevApp() <Badge text="v1.0.0" type="tip" />
...
### createServer() <Badge text="v1.0.0" type="tip" />
- **类型：**`(gez: Gez) => Promise<void>`
- **默认值：** `undefined`
- **描述：** 创建服务器
