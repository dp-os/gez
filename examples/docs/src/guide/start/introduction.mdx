...
- **v2.0**：采用 Webpack Module Federation 实现组件联邦
...
- **原生模块系统**：利用浏览器原生 ESM 和 Import Maps 实现依赖管理
...
### 核心技术栈
- **ESM 规范**：基于 [ESM dynamic import](https://caniuse.com/es6-module-dynamic-import) 和 [import.meta](https://caniuse.com/mdn-javascript_operators_import_meta)
