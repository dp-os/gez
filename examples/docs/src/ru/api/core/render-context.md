...
Код состояния HTTP-ответа. Можно установить любой допустимый код состояния HTTP, часто используется для обработки ошибок, перенаправлений и других сценариев.
