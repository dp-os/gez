...
description: La herramienta de construcción Rspack del framework Gez ofrece capacidades de construcción de aplicaciones de alto rendimiento, compatible con el desarrollo y construcción de aplicaciones estándar y aplicaciones HTML, con múltiples procesadores de recursos y configuraciones de optimización integradas.
head:
  - - meta
    - property: keywords
...
El paquete Rspack proporciona un conjunto de API para crear y configurar aplicaciones Rspack, compatible con la construcción y desarrollo de aplicaciones estándar y aplicaciones HTML.
...
Interfaz de contexto de configuración de aplicación Rspack, proporciona información de contexto accesible en las funciones de gancho de configuración:
...
- `styleLoader`: Loader para inyectar CSS en el DOM
- `cssLoader`: Loader para analizar archivos CSS y manejar la modularización de CSS
- `lessLoader`: Loader para compilar archivos Less a CSS
- `styleResourcesLoader`: Loader para importar automáticamente recursos de estilo globales (como variables, mixins)
- `workerRspackLoader`: Loader para procesar archivos de Web Worker
